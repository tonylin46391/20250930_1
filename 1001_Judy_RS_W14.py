...
def get_diff_html(a: str, b: str) -> str:
    ...
    def span(text, style):
        ...
        return f"<span style='{style}display:inline-block;width:20px;height:30px;line-height:23px;margin:1px;border-radius:4px;font-family:monospace;text-align:center;font-size:36px;'>{text}</span>"
